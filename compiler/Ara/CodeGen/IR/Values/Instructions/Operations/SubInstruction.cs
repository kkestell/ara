...
/// </summary>
public class SubInstruction : BinaryOperationInstruction
{
    public SubInstruction(Block block, Value left, Value right, string? name = null) : base(block, left, right, name)
    {
    }
