...
/// </summary>
public class SDivInstruction : BinaryOperationInstruction
{
    public SDivInstruction(Block block, Value left, Value right, string? name = null) : base(block, left, right, name)
    {
    }
