...
public class FAdd : Instruction
{
    ...
    public FAdd(Function function, Value left, Value right, string? name = null) : base(function, name)
    {
    ...
    {
        sb.Append($"{Resolve()} = fadd {_left.Type.ToIr()} {_left.Resolve()}, {_right.Resolve()}\n");
    }
}